...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    // Needs to create, name and associate files to a new distribution to get this value
    private let distributionHash = "0288a0142c55fa3b47137193vzc"
    private let sourceLanguage = "en"
    
    // tools -> content delivery -> get credentials
    private let clientId = "GXf6bMkw87JCoPWz4m0a"
    private let clientSecret = "89XbiDI9H7sr75E0R54NdmC9vEuoovPk9QzVgyt3"
